            ...
            {loading ? (
                ...
                <>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {/* Tarjeta Deuda Total */}
                        <div className="bg-gradient-to-br from-indigo-900 to-indigo-800 rounded-3xl p-6 text-white shadow-xl shadow-indigo-900/20 relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <h3 className="font-medium text-indigo-100 text-sm tracking-wide uppercase">Total Deuda a Favor</h3>
                                </div>
                                <div className="flex items-end gap-2">
                                    <span className="text-4xl font-bold tracking-tight">${totalDebt.toFixed(2)}</span>
                                </div>
                                <p className="text-xs text-indigo-300 mt-2">Saldo vivo total que debe la academia</p>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm relative overflow-hidden">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-medium text-slate-600 text-sm tracking-wide uppercase">Ciclo Actual (Sin Liquidar)</h3>
                            </div>
                            <div className="flex items-end gap-2">
                                <span className="text-3xl font-bold text-slate-900">${unliquidatedAmount.toFixed(2)}</span>
                            </div>
                            <p className="text-xs text-slate-500 mt-2">Dinero generado desde el último corte</p>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm relative overflow-hidden">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-medium text-slate-600 text-sm tracking-wide uppercase">Liquidaciones por Cobrar</h3>
                            </div>
                            <div className="flex items-end gap-2">
                                <span className="text-3xl font-bold text-slate-900">${liquidatedDebt.toFixed(2)}</span>
                            </div>
                            <p className="text-xs text-slate-500 mt-2">Cortes pasados aún no pagados por completo</p>
                        </div>
                        ...
                        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm relative overflow-hidden">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h3 className="font-medium text-slate-600 text-sm tracking-wide uppercase">Cursos Activos</h3>
                            </div>
                            <div className="flex items-end gap-2">
                                <span className="text-3xl font-bold text-slate-900">{activeCoursesCount}</span>
                            </div>
                    ...
                    <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden mt-8">
                        <div className="p-6 border-b border-slate-100 flex justify-between items-center">
                            ...
                            <Link to="/class-mode" className="text-sm font-medium text-blue-600 hover:text-blue-700">Dictar Nueva Clase</Link>
                        </div>
